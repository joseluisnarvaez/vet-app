            ...
            <ul class="navbar-nav">
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu p-0" aria-labelledby="appsDropdown">
                  ...
                  >
                    <p class="mb-2 fw-bold">Mis accesos</p>
                  </div>
                  <div class="row g-0 p-1">
                    <div class="col-6 text-center">
                      <a
                        href="#"
                        class="dropdown-item d-flex flex-column align-items-center justify-content-center"
                        ><i data-feather="folder" class="icon-lg mb-1"></i>
                        <p class="tx-12">Inventario</p></a
                      >
                    </div>
                    <div class="col-6 text-center">
                      <a
                      ...
                      <div class="d-flex justify-content-between flex-grow-1">
                        <div class="me-4">
                          ...
                          <p class="tx-12 text-muted">
                            Señor vetyerinario págme por favor
                          </p>
                        </div>
                ...
                >
                  ...
                  >
                    ...
                    <div class="text-center">
                      <p class="tx-16 fw-bolder">Veterinario Fuenzalida</p>
